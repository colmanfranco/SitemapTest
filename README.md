...
```
### Base response
![Cities Base Response](https://github.com/colmanfranco/SitemapTest/blob/master/img/citiesBaseResponse.png)
...
```
### Base response
![Activities Base Response](https://github.com/colmanfranco/SitemapTest/blob/master/img/activitiesBaseResponse.png)